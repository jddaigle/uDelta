...
#define DECOUPLING_TEST_MAX_HOLD_VARIANCE 100
...
#define EXT0_DECOUPLE_TEST_PERIOD 120000
...
#define USER_THERMISTORTABLE0 {\
   ...
   {4*1016, -21*8}};
/*
#define USER_THERMISTORTABLE0 {\ // v1.0
   {4*36, 1272*8},\
   {4*71, 778*8},\
   {4*106, 606*8},\
   {4*141, 511*8},\
...
#define Y_HOME_DIR -1
#define Z_HOME_DIR 1
#define X_MAX_LENGTH 55
#define Y_MAX_LENGTH 55
#define Z_MAX_LENGTH 196.5
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
...
#define ROD_RADIUS 65.5
#define PRINTER_RADIUS 65.5
...
#define STEPPER_INACTIVE_TIME 99999L
...
#define UI_PRINTER_NAME "eMotion Tech"
#define UI_PRINTER_COMPANY "Micro Delta"
...
========== Start configuration string ==========
{
    ...
    "deltaDiagonalRod": 147,
    "deltaHorizontalRadius": 65.5,
    "deltaAlphaA": 210,
    "deltaAlphaB": 330,
    "deltaAlphaC": 90,
    ...
    "deltaYOffsetSteps": 0,
    "deltaZOffsetSteps": 0,
    "deltaSegmentsPerLine": 10,
    "stepperHighDelay": 0,
    "directionDelay": 0,
    "stepDoublerFrequency": 10000,
    "allowQuadstepping": "1",
    "doubleStepDelay": 1,
    "maxJerk": 20,
    "maxZJerk": 0.3,
